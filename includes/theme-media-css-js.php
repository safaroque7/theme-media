...
function media_theme_css_js()
{
    ...
    wp_enqueue_style('responsive-css', get_template_directory_uri() . '/responsive.css', array(), '1.0', 'all');
    ...
    wp_enqueue_script('swiper-slider-js', get_template_directory_uri() . '/swiper-slider.js', array('jquery'), '1.0', true);
}
